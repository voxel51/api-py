...
man_pages = [
    (master_doc, 'pythonclientlibraryvoxel51api', 'Python Client Library Voxel51 API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PythonClientLibraryVoxel51API', 'Python Client Library Voxel51 API Documentation',
     author, 'PythonClientLibraryVoxel51API', 'One line description of project.',
     'Miscellaneous'),
]
